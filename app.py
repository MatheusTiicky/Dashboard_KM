...
def load_data():
    ...
    try:
        base_path = r'C:\Users\Matheus Souza\Documents\Teste'

        emissoes_df = pd.read_excel(f'{base_path}\\EMISSOES_KM.xlsx')
        ...
        cancelamentos_df = pd.read_excel(f'{base_path}\\CANCELAMENTOS_KM.xlsx')
